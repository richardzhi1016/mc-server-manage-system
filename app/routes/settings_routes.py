...
def update_startup_settings():
    ...
    backup_retention = data.get("backup_retention", 10)
    ...
    if not isinstance(backup_retention, int) or backup_retention < 5 or backup_retention > 50:
        return jsonify({"error": "backup_retention must be an integer between 5 and 50"}), 400
