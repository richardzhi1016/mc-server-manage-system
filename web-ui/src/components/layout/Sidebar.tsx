import { LayoutDashboard, Server, Settings, Users, Terminal, Folder, Database, ArrowLeftCircle, Package, Puzzle, PanelLeftClose, PanelLeftOpen, Bell, BarChart2 } from 'lucide-react'
  ...
  return (
    ...
    >
      ...
      <nav className="flex-1 px-2 py-3 space-y-0.5 overflow-y-auto overflow-x-hidden scrollbar-thin">
        ...
        <SidebarItem to={`${basePath}/analytics`} icon={<BarChart2 className="w-4 h-4" />} label="数据分析" collapsed={collapsed} />
